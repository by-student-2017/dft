...
// ---------- ----------- ------------ ------------
// Adsorbent
double Rcc; // radius of cylinder, [nm]
double Dcc; // diameter of cylinder, [nm]
double sigma_ss;
//#define nstep=1001;
...
double epsilon_ff;
double sigma_ff;
double d_hs; // diameter of hard sphere
double rc; // cut off radius
// ---------- ----------- ------------ ------------
...
double rho_si_int_k(double *rho_si_int_ijrj, double *r){
	...
	double tmp_rho_si_int_k[nhmesh];
	double tmp_rho_si_int_t[nrmesh];
	double x,y;
